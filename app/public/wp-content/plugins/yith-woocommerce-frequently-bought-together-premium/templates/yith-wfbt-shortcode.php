...
$title = get_option( 'yith-wfbt-slider-title', __( 'Customers who bought the items in your wishlist also purchased', 'yith-woocommerce-frequently-bought-together' ) ); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
		...
		<ul class="yith-wfbt-products-list products">
			...
			foreach ( $args['products'] as $product_id ) :
				...
				<li class="yith-wfbt-single-product product">
					...
					<?php if ( 'yes' === get_option( 'yith-wfbt-slider-product-image', 'yes' ) ) : ?>
					...
					<div class="yith-wfbt-product-info">
						...
						<?php if ( 'yes' === get_option( 'yith-wfbt-slider-product-title', 'yes' ) ) : ?>
						...
						<?php if ( $product->is_type( 'variation' ) && 'yes' === get_option( 'yith-wfbt-slider-product-variation', 'yes' ) ) : ?>
							<div class="product-attributes">
								<?php echo esc_html( implode( ',', $product->get_variation_attributes() ) ); ?>
							</div>
						<?php endif; ?>

						<?php echo wp_kses_post( 'yes' === get_option( 'yith-wfbt-slider-product-price', 'yes' ) ? '<div class="product-price">' . $product->get_price_html() . '</div>' : '' ); ?>

						<?php
						if ( 'yes' === get_option( 'yith-wfbt-slider-product-rating', 'yes' ) ) {
					...
					$label_buy  = esc_html( get_option( 'yith-wfbt-slider-buy-button', __( 'Add to cart', 'yith-woocommerce-frequently-bought-together' ) ) );
					$label_wish = esc_html( get_option( 'yith-wfbt-slider-wishlist-button', __( 'Add to Wishlist', 'yith-woocommerce-frequently-bought-together' ) ) );
					?>
