...
$title        = get_option( 'yith-wfbt-popup-title', __( 'Choose the product', 'yith-woocommerce-frequently-bought-together' ) ); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
...
<div class="yith-wfbt-wrap-single-product product">
	<div class="yith-wfbt-single-product-left">
		<figure class="product-image">
			<?php echo wp_kses_post( $single_product->get_image( 'shop_single' ) ); ?>
		</figure>
		<p class="product-name">
			<?php echo wp_kses_post( apply_filters( 'yith_wfbt_modal_product_name', $single_product->get_formatted_name(), $single_product ) ); ?>
		</p>
	</div>
