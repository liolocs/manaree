...
$general = array(
	'general' => array(
		...
		array(
			'id'        => 'yith-wfbt-show-discount-save',
			'title'     => __( 'Highlight discount', 'yith-woocommerce-frequently-bought-together' ),
			'desc'      => __( 'Show the discount amount in the Frequently Bought Together box.', 'yith-woocommerce-frequently-bought-together' ),
			'type'      => 'yith-field',
			'yith-type' => 'onoff',
			'default'   => 'off',
		),
...
/**
 * APPLY_FILTERS: yith_wcfbt_panel_general_options
 *
