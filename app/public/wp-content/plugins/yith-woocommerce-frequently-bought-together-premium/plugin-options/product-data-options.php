...
$product_data = array(
	...
	array(
		...
		'discount_fixed'        => array(
			...
			'type'  => 'text',
			'class' => array( 'wc_input_price', 'inline-desc' ),
			'data'  => array(
		...
		'discount_percentage'   => array(
			...
			'desc'  => '%',
			'type'  => 'number',
			'class' => array( 'wc-product-number', 'inline-desc' ),
			'attr'  => array(
				'min' => 0,
				'max' => 100,
			),
...
/**
 * APPLY_FILTERS: yith_wcfbt_panel_product_data_options
 *
 * Filters the options available in the product panel.
 *
