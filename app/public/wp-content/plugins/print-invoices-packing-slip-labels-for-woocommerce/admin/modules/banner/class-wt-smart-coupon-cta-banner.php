 ...
 */
if (!class_exists('\\Wtpdf\\Banners\\Wt_Smart_Coupon_Cta_Banner')) {
    class Wt_Smart_Coupon_Cta_Banner {
        /**
         * Constructor.
         */
        ...
        public function enqueue_scripts($hook) { 
           if (!in_array($hook, array('post.php', 'post-new.php')) || get_post_type() !== 'shop_coupon') {
            ...
            wp_enqueue_style(
                'wt-pklist-cta-banner',
                plugin_dir_url(__FILE__) . 'assets/css/wt-pklist-cta-banner.css',
                array(),
                WF_PKLIST_VERSION
            );
            ...
            wp_enqueue_script(
                'wt-pklist-cta-banner',
                plugin_dir_url(__FILE__) . 'assets/js/wt-pklist-cta-banner.js',
                array('jquery'),
                WF_PKLIST_VERSION,
                true
            );
            ...
            wp_localize_script('wt-pklist-cta-banner', 'wt_smart_coupon_cta_banner_ajax', array(
    ...
    new \Wtpdf\Banners\Wt_Smart_Coupon_Cta_Banner();
} 