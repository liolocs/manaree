...
if ( class_exists( 'Iconic_WDS_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_WDS_Core_Cross_Sells.
 *
 * @class    Iconic_WDS_Core_Cross_Sells
 * @version  1.0.0
 */
class Iconic_WDS_Core_Cross_Sells {
	/**
	 ...
	 *
	 * @var Iconic_WDS_Core_License_Uplink
	 */
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_jckwds', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=jckwds', $base_url );
