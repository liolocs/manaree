...
class Iconic_WDS_Settings {
	...
	public static function run() {
		add_action( 'wp_loaded', array( __CLASS__, 'init_settings' ) );
	...
	public static function get_delivery_days( $context = 'admin', $product_ids = array() ) {
		...
		if ( 'frontend' === $context ) {
			$cart_product_specific_days = Iconic_WDS_Override_Settings::get_product_specific_days_setting( $product_ids );
	...
	public static function validate_settings( $settings ) {
		...
		if ( ! empty( $holidays ) ) {
			...
			$original_format                = Iconic_WDS_Helpers::date_format( $jckwds->settings['datesettings_datesettings_dateformat'] );
			$new_format                     = Iconic_WDS_Helpers::date_format( $settings['datesettings_datesettings_dateformat'] );
