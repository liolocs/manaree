 ...
 */
class Iconic_WDS_Reservation_Table {
	...
	public static function calculate_shipping() {
		try {
			...
			$address['country']  = Iconic_WDS_Helpers::get_filtered_input( 'calc_shipping_country' );
			$address['state']    = Iconic_WDS_Helpers::get_filtered_input( 'calc_shipping_state' );
			$address['postcode'] = Iconic_WDS_Helpers::get_filtered_input( 'calc_shipping_postcode' );
			$address['city']     = Iconic_WDS_Helpers::get_filtered_input( 'calc_shipping_city' );
