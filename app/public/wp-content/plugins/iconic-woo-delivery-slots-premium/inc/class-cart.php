...
class Iconic_WDS_Cart {
	 ...
	 * Constructor.
	 *
	 * @param array $products Associative arroy of products in this format array( product_id_1 => qty_1, product_id_2 => qty_2, ... ).
	 */
	 ...
	 * @return array
	 */
	public function prepare_product( $product, $qty ) {
