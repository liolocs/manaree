	...
	$wpsf_settings['sections'][] = array(
		...
		'fields'              => array(
			...
			array(
				...
				'type'     => 'custom',
				'default'  => array(),
				'output'   => Iconic_WDS_Settings::get_products_search_field( 'general_setup', 'max_orders_exclude_products' ),
			),
			array(
				'id'       => 'labels',
			...
			array(
				...
				'type'     => 'custom',
				'default'  => array(),
				'output'   => Iconic_WDS_Settings::get_products_search_field( 'general_setup', 'exclude_products' ),
			),
			array(
	...
	$wpsf_settings['sections'][] = array(
		...
		'fields'              => array(
			...
			array(
				...
				'output'   => Iconic_WDS_Settings::get_field_timeslot_editing_window(),
			),
			array(
	...
	$wpsf_settings['sections'][] = array(
		...
		'fields'              => array(
			...
			array(
				...
				'type'     => 'custom',
				'output'   => Iconic_WDS_Settings::get_reminder_duration_fields(),
				'default'  => 12,
			),
			array(
				'id'       => 'max_emails',
