...
namespace Iconic_WDS_NS\StellarWP\Telemetry\Exit_Interview;

use Iconic_WDS_NS\StellarWP\ContainerContract\ContainerInterface;
use Iconic_WDS_NS\StellarWP\Telemetry\Admin\Resources;
use Iconic_WDS_NS\StellarWP\Telemetry\Config;
use Iconic_WDS_NS\StellarWP\Telemetry\Contracts\Template_Interface;
use Iconic_WDS_NS\StellarWP\Telemetry\Core;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \Iconic_WDS_NS\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \Iconic_WDS_NS\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
