...
namespace Iconic_WDS_NS\StellarWP\Uplink\View;

use Iconic_WDS_NS\StellarWP\Uplink\View\Exceptions\FileNotFoundException;
	...
	private function get_path( string $name ): string {
		...
		if( $path === false ) {
			throw new FileNotFoundException(
				sprintf( __( 'View file "%s" not found or not readable.', 'jckwds' ), $file )
			);
		}
