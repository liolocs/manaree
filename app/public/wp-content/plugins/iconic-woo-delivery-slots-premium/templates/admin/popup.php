...
?>
<div class='wds-admin-popup-wrap' id="wds-admin-popup-wrap" v-cloak v-show="showPopup" @click.self="popup(false)" data-init="<?php echo esc_attr( wp_json_encode( Iconic_WDS_Order::get_order_date_time( $order ) ) ); ?>">
