...
<style>
	...
	:root {
		...
		/* 20% darker */
		--wds-primary-hover: <?php echo esc_html( Iconic_WDS_Helpers::adjust_color_brightness( $iconic_wds->settings['reservations_reservations_highlight_color'], -0.2 ) ); ?>;
		/* 90% lighter */
		--wds-primary-lighter: <?php echo esc_html( Iconic_WDS_Helpers::adjust_color_brightness( $iconic_wds->settings['reservations_reservations_highlight_color'], 0.9 ) ); ?>;
		--wds-border: #DEDEDE;
