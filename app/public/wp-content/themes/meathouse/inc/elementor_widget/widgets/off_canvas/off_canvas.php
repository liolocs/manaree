...
class Offcanvas extends Widget_Base {
	...
	protected function register_general_content_controls() {
		...
		$this->add_control(
			'preview_offcanvas',
			[
				'label'        => esc_html__( 'Preview', 'meathouse' ),
        ...
        $this->add_control(
			'animation_offcanvas',
			[
				'label'        => esc_html__( 'Animation', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
		...
		$this->add_control(
			'content_type',
			[
				'label'   => esc_html__( 'Content Type', 'meathouse' ),
		...
		if ( ! empty( $menus ) ) {
			...
			$this->add_control(
				...
				[
					...
					/* translators: %s admin link */
					'raw'             => sprintf( esc_html__( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'meathouse' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
		...
		$this->add_control(
			...
			[
				...
				'default'    => esc_html__( 'Enter content here. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.​ Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'meathouse' ),
				'rows'       => 10,
				'show_label' => false,
				'dynamic'    => [
					'active' => true,
		...
		$this->add_control(
			'ct_saved_rows',
			[
				'label'     => esc_html__( 'Select Section', 'meathouse' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_control(
			'ct_page_templates',
			[
				'label'     => esc_html__( 'Select Page', 'meathouse' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_control(
			'ct_saved_modules',
			[
				'label'     => esc_html__( 'Select Widget', 'meathouse' ),
				'type'      => Controls_Manager::SELECT,
	...
	protected function register_display_content_controls() {
		$this->start_controls_section(
			'offcanvas',
			[
				'label' => esc_html__( 'Display Settings', 'meathouse' ),
			]
		);
        $this->add_control(
			'use_login',
			[
				'label'        => esc_html__( 'Use For Login', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
        ...
        $this->add_control(
			'use_login_dropdown',
			[
				'label'        => esc_html__( 'Use Dropdown Link After Login', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
        ...
        $this->add_control(
			'turn_off_popup',
			[
				'label'        => esc_html__( 'Turn Off Popup', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
		...
		$this->add_control(
			'offcanvas_on',
			[
				'label'   => esc_html__( 'Display On', 'meathouse' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'button',
				'options' => [
					'button'    => esc_html__( 'Button', 'meathouse' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Click Me', 'meathouse' ),
                'default' => '',
				'dynamic'     => [
					'active' => true,
				],
        ...
        $this->add_control(
			...
			[
				'label'       => esc_html__( 'Button Text After Login', 'meathouse' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Click Me', 'meathouse' ),
				'dynamic'     => [
					'active' => true,
        ...
        $this->add_control(
			'btn_url_after_login',
			[
				'label' => esc_html__( 'Button Url After Login', 'meathouse' ),
				'type' => Controls_Manager::URL,
				'placeholder' => esc_html__( 'Loged Url', 'meathouse' ),
                'dynamic'		=> [ 'active' => true ],
                'condition'   => [
					'offcanvas_on' => 'button',
                    'use_login' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'options'      => [
					...
					'floating' => esc_html__( 'Floating', 'meathouse' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'          => esc_html__( 'Floating Position', 'meathouse' ),
		...
		$this->add_control(
				...
				[
					'label'            => esc_html__( 'Select Icon', 'meathouse' ),
       ...
       $this->add_control(
        ...
        $this->add_responsive_control(
			'btn_icon_padding',
			[
				'label'      => esc_html__( 'Icon Padding', 'meathouse' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'options'     => [
					'right' => esc_html__( 'After Text', 'meathouse' ),
					'left'  => esc_html__( 'Before Text', 'meathouse' ),
				],
				'conditions'  => [
					'relation' => 'and',
					'terms'    => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Icon Spacing', 'meathouse' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'Adjust the z-index of the floating trigger if it is not visibile on the page. Defaults is set to 999', 'meathouse' ),
	...
	protected function register_close_controls() {
		$this->start_controls_section(
			'section_close',
			[
				'label' => esc_html__( 'Close Button', 'meathouse' ),
			]
		);
		...
		$this->add_control(
				'new_close_icon',
				[
					'label'            => esc_html__( 'Select Close Icon', 'meathouse' ),
					'type'             => Controls_Manager::ICONS,
				]
		);
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Icon Alignment', 'meathouse' ),
				'type'       => Controls_Manager::SELECT,
				'default'    => 'right-top',
				'options'    => [
					'left-top'  => esc_html__( 'Left Top', 'meathouse' ),
					'right-top' => esc_html__( 'Right Top', 'meathouse' ),
				],
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
		...
		$this->add_control(
			'esc_keypress',
			[
				'label'        => esc_html__( 'Close on ESC Keypress', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
		...
		$this->add_control(
			'overlay_click',
			[
				'label'        => esc_html__( 'Close on Overlay Click', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'meathouse' ),
	...
	protected function register_button_style_controls() {
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::RAW_HTML,
				'raw'       => sprintf( '<p style="font-size: 11px;font-style: italic;line-height: 1.4;color: #a4afb7;">%s</p>', esc_html__( 'To see these changes please turn off the preview setting from Content Tab.', 'meathouse' ) ),
				'condition' => [
	...
	protected function register_html_animation_style_controls() {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Html Animation', 'meathouse' ),
				'tab'       => Controls_Manager::TAB_STYLE,
	...
	protected function register_close_icon_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label'      => esc_html__( 'Close Icon', 'meathouse' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
	...
	protected function register_offcanvas_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Off - Canvas', 'meathouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function register_content_style_controls() {
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					'name'        => 'content_border',
					'label'       => esc_html__( 'Content Border', 'meathouse' ),
					'placeholder' => '1px',
					'default'     => '1px',
	...
	protected function register_display_offcanvas_controls() {
		...
		$this->add_responsive_control(
			'offcanvas_width',
			[
				'label'          => esc_html__( 'Width (px)', 'meathouse' ),
				'type'           => Controls_Manager::SLIDER,
				'size_units'     => [ 'px', '%' ],
				'default'        => [
					'size' => '300',
        ...
        $this->add_responsive_control(
			'offcanvas_height',
			[
				'label'          => esc_html__( 'Height (px)', 'meathouse' ),
				'type'           => Controls_Manager::SLIDER,
				'size_units'     => [ 'px', '%' ],
				'range'          => [
					'px' => [
		...
		$this->add_control(
			'offcanvas_type',
			[
				'label'       => esc_html__( 'Appear Effect', 'meathouse' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'normal',
				'label_block' => false,
				'options'     => [
					'normal' => esc_html__( 'Slide', 'meathouse' ),
                    'fade'   => esc_html__( 'Fade', 'meathouse' ),
				],
				'render_type' => 'template',
			]
		);
		...
		$this->add_control(
			'page_overlay',
			[
				'label'       => esc_html__( 'Overlay Color', 'meathouse' ),
				'type'        => Controls_Manager::COLOR,
	...
	public function get_content_type() {
		$content_type = array(
			'content'              => esc_html__( 'Content', 'meathouse' ),
			'menu'                 => esc_html__( 'Menu', 'meathouse' ),
			'saved_rows'           => esc_html__( 'Saved Section', 'meathouse' ),
			'saved_page_templates' => esc_html__( 'Saved Page', 'meathouse' ),
		);

		if ( defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			$content_type['saved_modules'] = esc_html__( 'Saved Widget', 'meathouse' );
		}
		return $content_type;
	}
	...
	public function render_button( $node_id, $settings ) {
        ...
        if ( is_user_logged_in() || isset($_GET['p']) || $settings['turn_off_popup'] == 'yes') {  
		...
		<div <?php echo ''.$this->get_render_attribute_string( 'wrapper' ); ?>>
            ...
            <?php if(class_exists('Woocommerce') && $settings['use_login_dropdown'] == 'yes' && is_user_logged_in()) { ?>
	...
	protected function render_button_text() {
		...
		<span <?php echo ''.$this->get_render_attribute_string( 'content-wrapper' ); ?>>
			...
			<span <?php echo ''.$this->get_render_attribute_string( 'btn-text' ); ?>><?php
                    ...
                    if ( (is_user_logged_in() || isset($_GET['p'])) && $settings['use_login'] == 'yes' ) {  
                        echo ''.$settings['btn_text_after_login'];
                    }else {
		...
		if ( 'button' === $settings['offcanvas_on'] ) {
			...
			if ( ( 'floating' === $settings['jws_display_position'] ) && $is_editor ) {
				...
				<div class="jws-builder-msg" style="text-align: center;">
					<h5><?php esc_html_e( 'Off - Canvas - ID ', 'meathouse' ); ?><?php echo esc_attr($id); ?></h5>
					<p><?php esc_html_e( 'Click here to edit the "Off- Canvas" settings. This text will not be visible on frontend.', 'meathouse' ); ?></p>
				</div>
