...
class Jws_Product_Group extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Product Group', 'meathouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'button_url',
			[
				'label' => esc_html__( 'Button Url', 'meathouse' ),
	    ...
	    $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Product List', 'meathouse' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);   
        ...
        $repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Text for map', 'meathouse' ),
			]
		);
        ...
        $repeater->add_control(
			'image',
			[
				'label' => esc_html__( 'Choose Image Maps', 'meathouse' ),
        ...
        for($i = 1 ; $i <= 4 ; $i++) {
            ...
            $repeater->add_control('inc_product_ids_'.$i.'', [
                'label' => esc_html__('Choose product', 'meathouse'),
