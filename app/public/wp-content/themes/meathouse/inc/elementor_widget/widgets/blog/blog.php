...
class Jws_Blog extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Blog', 'meathouse' );
	}
	...
	*/
	protected function register_content_general_controls() {
		...
		$this->start_controls_section(
            ...
            $this->add_control(
				...
				[
					...
					'options'   => [
                        ...
                        'mixed'   => esc_html__( 'Mixed', 'meathouse' ),
            ...
            $this->add_control(
    			'enable_masonry',
    			[
    				'label' => esc_html__( 'Enable Masonry', 'meathouse' ),
            ...
            $this->add_control(
    			'enable_animation',
    			[
    				'label' => esc_html__( 'Enable Animation', 'meathouse' ),
    				'type' => \Elementor\Controls_Manager::SWITCHER,
    				'label_on' => esc_html__( 'On', 'meathouse' ),
    				'label_off' => esc_html__( 'Off', 'meathouse' ),
    				'return_value' => 'yes',
            ...
            $this->add_control(
    			...
    			[
    				...
    				'label_off' => esc_html__( 'Default', 'meathouse' ),
    				'label_on' => esc_html__( 'Custom', 'meathouse' ),
    				'return_value' => 'yes',
    				'default' => 'yes',
    			]
		    );
            ...
            $this->add_control(
				'excerpt_length',
				[
					'label'     => esc_html__( 'Excerpt Length', 'meathouse' ),
             ...
             $this->add_control(
				'excerpt_more',
				[
					'label'     => esc_html__( 'Excerpt More', 'meathouse' ),
					'type'      => Controls_Manager::TEXT,
					'default'   => ' ... ',
				]
			);
            $this->add_control(
				'readmore_text',
				[
					'label'     => esc_html__( 'Read More Text', 'meathouse' ),
					'type'      => Controls_Manager::TEXT,
					'default'   => 'Read More',
				]
			);
            $this->add_control(
				'icon',
				[
					'label' => esc_html__( 'Read More Icon', 'meathouse' ),
          ...
          $this->add_control(
			'post_archive',
			[
				'label' => esc_html__( 'Show Post For Archive Category', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'meathouse' ),
				'label_off' => esc_html__( 'Off', 'meathouse' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'post_related',
			[
				'label' => esc_html__( 'Show post related for single blog', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'meathouse' ),
				'label_off' => esc_html__( 'Off', 'meathouse' ),
				'return_value' => 'yes',
          ...
          $this->add_control(
			'ajax_page',
			[
				'label' => esc_html__( 'ajax_page', 'meathouse' ),
          ...
          $this->add_control(
    				...
    				[
    					...
    					'return_value' => 'yes',
    					'description'  => esc_html__( 'Enable nav filter post.', 'meathouse' ),
    				]
    	   );
           $this->add_control(
				'post_text_first',
				[
					'label'     => esc_html__( 'Nav Text All', 'meathouse' ),
					'type'      => Controls_Manager::TEXT,
	...
	protected function register_content_filter_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Query', 'meathouse' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
						'post_archive!' => [ 'yes' ],
                        'post_related!' => [ 'yes' ],
        ...
        $this->add_control(
				'blog_per_page',
				[
					'label'     => esc_html__( 'posts Per Page', 'meathouse' ),
		...
		$this->add_control(
				...
				[
					...
					'default' => 'all',
					'options' => [
						'all'    => esc_html__( 'All posts', 'meathouse' ),
						'custom' => esc_html__( 'Custom Query', 'meathouse' ),
						'manual' => esc_html__( 'Manual Selection', 'meathouse' ),
					],
				]
			);
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Category Filter Rule', 'meathouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'IN',
					'options'   => [
						'IN'     => esc_html__( 'Match Categories', 'meathouse' ),
						'NOT IN' => esc_html__( 'Exclude Categories', 'meathouse' ),
					],
					'condition' => [
						'query_type' => 'custom',
					],
			...
			$this->add_control(
				'category_filter',
				[
					'label'     => esc_html__( 'Select Categories', 'meathouse' ),
			...
			$this->add_control(
				'tag_filter_rule',
				[
					'label'     => esc_html__( 'Tag Filter Rule', 'meathouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'IN',
					'options'   => [
						'IN'     => esc_html__( 'Match Tags', 'meathouse' ),
						'NOT IN' => esc_html__( 'Exclude Tags', 'meathouse' ),
					],
					'condition' => [
						'query_type' => 'custom',
					],
			...
			$this->add_control(
				'tag_filter',
				[
					'label'     => esc_html__( 'Select Tags', 'meathouse' ),
					'type'      => Controls_Manager::SELECT2,
					'multiple'  => true,
					'default'   => '',
			...
			$this->add_control(
				'offset',
				[
					'label'       => esc_html__( 'Offset', 'meathouse' ),
					'type'        => Controls_Manager::NUMBER,
					'default'     => 0,
					'description' => esc_html__( 'Number of post to displace or pass over.', 'meathouse' ),
					'condition'   => [
						'query_type' => 'custom',
					],
				]
			...
			$this->add_control(
				'query_manual_ids',
				[
					'label'     => esc_html__( 'Select posts', 'meathouse' ),
			...
			$this->add_control(
				'query_exclude',
				[
					'label'     => esc_html__( 'Exclude', 'meathouse' ),
			...
			$this->add_control(
				...
				[
					...
					'post_type'   => 'post',
					'multiple'    => true,
					'description' => esc_html__( 'Select posts to exclude from the query.', 'meathouse' ),
					'condition'   => [
						'query_type!' => [ 'manual', 'main' ],
					],
				]
			...
			$this->add_control(
				...
				[
					'label'        => esc_html__( 'Exclude Current post', 'meathouse' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => esc_html__( 'Yes', 'meathouse' ),
					'label_off'    => esc_html__( 'No', 'meathouse' ),
					'return_value' => 'yes',
					'default'      => '',
					'description'  => esc_html__( 'Enable this option to remove current post from the query.', 'meathouse' ),
					'condition'    => [
						'query_type!' => [ 'manual', 'main' ],
					],
				]
			...
			$this->add_control(
				'query_advanced',
				[
					'label'     => esc_html__( 'Advanced', 'meathouse' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'query_type!' => 'main',
			...
			$this->add_control(
				'filter_by',
				[
					'label'     => esc_html__( 'Filter By', 'meathouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => '',
					'options'   => [
						''         => esc_html__( 'None', 'meathouse' ),
						'featured' => esc_html__( 'Featured', 'meathouse' ),
						'sale'     => esc_html__( 'Sale', 'meathouse' ),
					],
					'condition' => [
						'query_type!' => 'main',
					],
			...
			$this->add_control(
				...
				[
					...
					'options'   => [
						...
						'post__in' => esc_html__( 'Post In', 'meathouse' ),
					],
					'condition' => [
						'query_type!' => 'main',
					],
			...
			$this->add_control(
				...
				[
					...
					'default'   => 'desc',
					'options'   => [
						'desc' => esc_html__( 'Descending', 'meathouse' ),
						'asc'  => esc_html__( 'Ascending', 'meathouse' ),
					],
					'condition' => [
						'query_type!' => 'main',
					],
	...
	protected function register_content_grid_controls() {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Grid Options', 'meathouse' ),
	...
	protected function register_content_pagination_controls() {
		...
		$this->add_control(
				...
				[
					...
					'options'   => [
						''              => esc_html__( 'None', 'meathouse' ),
                        'load_more' => esc_html__( 'Load More', 'meathouse' ),
                        'pagination-number' => esc_html__( 'Number Pagination', 'meathouse' ),
					],
				]
		);
        $this->add_control(
				...
				[
					'label'     => esc_html__( 'Loadmore Label', 'meathouse' ),
					'default'   => esc_html__( 'Load more posts', 'meathouse' ),
					'condition' => [
	...
	protected function register_content_slider_controls() {
        ...
        $this->add_control(
			'rtl',
			[
				'label'        => esc_html__( 'Right To Left', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
			]
        ...
        $this->add_control(
			'title_color_hover',
			[
				'label' => esc_html__( 'Title Color Hover', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '',
				'selectors' => [
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography Hover', 'meathouse' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Underline Color Hover', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->start_controls_section(
			'excerpt_style',
			[
				'label' => esc_html__( 'Excerpt', 'meathouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
			'show_excerpt',
			[
				'label' => esc_html__( 'Show Excerpt', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
			'excerpt_color',
			[
				'label' => esc_html__( 'Excerpt Color', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'show_date',
			[
				'label' => esc_html__( 'Show Date', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'meathouse' ),
				'label_off' => esc_html__( 'Hide', 'meathouse' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'show_readmore',
			[
				'label' => esc_html__( 'Show Readmore', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'meathouse' ),
				'label_off' => esc_html__( 'Hide', 'meathouse' ),
				'return_value' => 'yes',
	...
	protected function render() {
      ...
      if($settings['blog_display'] == 'slider') {
            $class_row .= ' carousel jws_blog_'.$settings['blog_display'].'';
      ...
      ?>
		...
		<div class="jws-blog-element<?php if($settings['post_nav_on'] == 'yes') echo esc_attr(' has-nav'); ?> jws-carousel">
            ...
            <div class="post_nav_container">
                <ul class="post_nav">
                    <li><a href="#" data-filter="*" class="filter-active"><?php echo (!empty($settings['post_text_first'])) ? $settings['post_text_first'] : esc_html__('All CATEGORIES', 'meathouse'); ?></a></li>
                    <?php
                        foreach ($cats as $cat) {
                            ?>
            ...
            <?php if ( $number_page > 1 && $settings['pagination_type'] == 'load_more' ) {
                ...
                <div class="jws_pagination jws_ajax">
                    <a class="jws-load-more btn-main"  data-ajaxify="true"  href="<?php echo add_query_arg( 'ajaxify', '1', $url); ?>" <?php echo wp_kses_post($load_attr); ?>>
                       ...
                       <span class="has-loaded"><?php echo esc_html__('All items loaded ','meathouse'); ?></span> 
                    </a>
                </div>
