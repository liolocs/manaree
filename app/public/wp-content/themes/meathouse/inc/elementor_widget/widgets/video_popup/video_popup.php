...
class Video_popup extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Video Popup', 'meathouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
				...
				[
					...
					'default'   => 'overlay',
					'options'   => [
                        'overlay'   => esc_html__( 'Overlay', 'meathouse' ),
						'border_ani'   => esc_html__( 'Border Animation', 'meathouse' ),
                        'border'   => esc_html__( 'Border', 'meathouse' ),
					],
				]
		);
        $this->add_control(
        ...
        $this->add_control(
			'url',
			[
				'label' => esc_html__( 'URl Video', 'meathouse' ),
				'type' =>  Controls_Manager::TEXT,
				'default' => esc_html__( 'https://www.youtube.com/watch?v=JtVd7q25FDA', 'meathouse' ),
			]
        ...
        $this->add_control(
			'icon_type',
			[
				'label' => esc_html__( 'Icon Background Type', 'meathouse' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'classic'    => [
        ...
        $this->add_control(
				...
				[
					...
					'selectors' 	=> [
						'{{WRAPPER}} .jws_video_popup .jws_video_popup_inner a span' => 'height: {{SIZE}}px;line-height: {{SIZE}}px;width: {{SIZE}}px;',
                        '{{WRAPPER}} .jws_video_popup .jws_video_popup_inner a:before' => 'height:{{SIZE}}px; width:{{SIZE}}px;',
                        '{{WRAPPER}} .jws_video_popup .jws_video_popup_inner a:after' => 'height: {{SIZE}}px; width:{{SIZE}}px;',
					],
                    'condition' => [
						 'skins' => 'border_ani',
				    ],
        ...
        $this->add_control(
					'icon_bgcolor2',
					[
						'label' 	=> esc_html__( 'Icon Background Overlay Color', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Icon Border Color', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Icon Border Color Animation', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
							'{{WRAPPER}} .jws_video_popup.video-border .jws_video_popup_inner a:before' => 'border-color: {{VALUE}};',
