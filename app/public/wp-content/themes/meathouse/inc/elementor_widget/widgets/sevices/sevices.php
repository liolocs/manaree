...
class Sevices extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Services', 'meathouse' );
	}
	...
	protected function register_content_general_controls() {
            ...
            $this->add_control(
				...
				[
					...
					'default'   => 'gird',
					'options'   => [
						'gird'   => esc_html__( 'Grid', 'meathouse' ),
                        'masonry'   => esc_html__( 'Masonry', 'meathouse' ),
			...
			$this->add_control(
				...
				[
					...
					'options'   => [
						...
						'price'      => esc_html__( 'Price', 'meathouse' ),
						'popularity' => esc_html__( 'Popularity', 'meathouse' ),
						'rating'     => esc_html__( 'Rating', 'meathouse' ),
