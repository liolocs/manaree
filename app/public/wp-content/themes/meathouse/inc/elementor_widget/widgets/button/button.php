...
class Gradient_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Button', 'meathouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'defautl',
				'options' => [
					'defautl' => esc_html__( 'Default', 'meathouse' ),
					'with_border' => esc_html__( 'With Border', 'meathouse' ),
                    'with_line' => esc_html__( 'With Line Animation', 'meathouse' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Click here', 'meathouse' ),
				'placeholder' => esc_html__( 'Click here', 'meathouse' ),
			]
		);
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'meathouse' ),
		...
		$this->add_control(
			'button_css_id',
			[
				'label' => esc_html__( 'Button ID', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'title' => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'meathouse' ),
				'label_block' => false,
				'description' => esc_html__( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'meathouse' ),
				'separator' => 'before',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Hover With Box', 'meathouse' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-button' => '--btn-color: {{VALUE}};',
				],
			]
		);
        $this->add_control(
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
                'selectors' => [
					'{{WRAPPER}} .elementor-button' => '--btn-bgcolor: {{VALUE}};',
				],
				'default' => '',
                'condition' => [
					'button_type' => 'classic',
        ...
        $this->add_group_control(
			...
			[
				...
				'label'                 => esc_html__( 'Text Shadow', 'meathouse' ),
				'selector'              => '{{WRAPPER}} a.elementor-button, {{WRAPPER}} .elementor-button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-button' => '--btn-color2: {{VALUE}};',
				],
			]
		);
         $this->add_control(
			...
			[
				'label' => esc_html__( 'ICon Color Hover', 'meathouse' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
                'selectors' => [
					'{{WRAPPER}} .elementor-button' => '--btn-bgcolor2: {{VALUE}};',
				],
				'default' => '',
                'condition' => [
					'button_type' => 'classic',
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => esc_html__( 'Hover Animation', 'meathouse' ),
