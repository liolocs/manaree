...
class Iframe extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Iframe', 'meathouse' );
	}
	...
	protected function register_controls() {
       ...
       $this->add_control(
			'embed',
			[
			    'label' => esc_html__( 'Embed Url', 'meathouse' ),
        ...
        $this->add_control(
			'width',
			[
			    'label' => esc_html__( 'Embed Width', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '1920', 'meathouse' ),
			]
		);
        $this->add_control(
			'height',
			[
			    'label' => esc_html__( 'Embed Height', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '964', 'meathouse' ),
			]
		);
