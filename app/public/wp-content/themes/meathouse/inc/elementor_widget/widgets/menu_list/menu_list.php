...
class Menu_list extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Menu list', 'meathouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
				'hover_skin',
				[
					'label'     => esc_html__( 'Hover Skin', 'meathouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'default',
					'options'   => [
						'default'   => esc_html__( 'Default', 'meathouse' ),
						'line_pd'   => esc_html__( 'Line And Padding', 'meathouse' ),
                        'line_sm'   => esc_html__( 'Line small', 'meathouse' ),
					],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => esc_html__( 'Default', 'meathouse' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => esc_html__( 'Inline', 'meathouse' ),
        ...
        $this->add_control(
    			'use_tooltip',
    			[
    				'label' => esc_html__( 'Enable Tooltip', 'meathouse' ),
        ...
        $this->add_control(
    			'toggle_mobile',
    			[
    				'label' => esc_html__( 'Enable Toggle Show/Hide On Mobile', 'meathouse' ),
    				'type' => \Elementor\Controls_Manager::SWITCHER,
    				'label_on' => esc_html__( 'On', 'meathouse' ),
    				'label_off' => esc_html__( 'Off', 'meathouse' ),
    				'return_value' => 'true',
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'List Item', 'meathouse' ),
				'default' => esc_html__( 'List Item', 'meathouse' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => esc_html__( 'List Item #1', 'meathouse' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #2', 'meathouse' ),
						'selected_icon' => [
							'value' => 'fas fa-times',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #3', 'meathouse' ),
						'selected_icon' => [
		...
		$this->add_control(
			'divider',
			[
				'label' => esc_html__( 'Divider', 'meathouse' ),
        ...
        $this->add_control(
			'line_color',
			[
				'label' => esc_html__( 'Line Background', 'meathouse' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'text_indent',
			[
				'label' => esc_html__( 'Text Indent', 'meathouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
