...
class Account extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Account Popup', 'meathouse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'show_text',
            [
                'label'         => esc_html__( 'Show Text(Name User)', 'meathouse' ),
        ...
        $this->add_control(
			'text_position',
			[
				'label' => esc_html__( 'Text Position', 'meathouse' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Login / Register', 'meathouse' ),
                'condition'	=> [
						'show_text' => 'yes',
				],
			]
        ...
        $this->add_control(
			'text_after_login',
			[
				'label' => esc_html__( 'Text After Login', 'meathouse' ),
				'type' =>  Controls_Manager::TEXT,
				'default' => esc_html__( 'My Accounts', 'meathouse' ),
                'condition'	=> [
						'show_text' => 'yes',
				],
			]
        ...
        $this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Login / Register Url', 'meathouse' ),
                'dynamic'		=> [ 'active' => true ],
        ...
        $this->add_control(
			'ac_link_2',
			[
				'label' => esc_html__( 'My Acccount When Logged', 'meathouse' ),
				'type' => Controls_Manager::URL,
				'placeholder' => esc_html__( 'My Account Url', 'meathouse' ),
                'dynamic'		=> [ 'active' => true ],
        ...
        $this->start_controls_section(
			'popup_style',
			[
				'label' => esc_html__( 'Popup Style', 'meathouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
			...
			[
				'name' => 'background',
				'label' => esc_html__( 'Background Overlay', 'meathouse' ),
