...
class Tooltip extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Tooltip', 'meathouse' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Tooltip', 'meathouse' ),
			]
		);
        $this->add_control(
			'image',
			[
				'label' => esc_html__( 'Choose Image Tooltip', 'meathouse' ),
        ...
        $this->add_responsive_control(
			'image_width',
			[
				'label' => esc_html__( 'Image Map Width', 'meathouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'%' => [
						'min' => 1,
    					...
    					<div class="tooltip-content">
                            <?php  
                                    if(!empty($item['inc_product_ids'])) {
                                        ...
                                        echo esc_html__('No product','meathouse');
                                    }       
                            ?>
