...
class Login_form extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Login Form', 'meathouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
				...
				[
					...
					'default'   => 'form',
					'options'   => [
						'form'   => esc_html__( 'Form', 'meathouse' ),
        ...
        $this->add_control(
				'icon',
				[
					'label'            => esc_html__( 'Select Icon Tigger', 'meathouse' ),
        ...
        $this->add_control(
				'display_active',
				[
					'label'     => esc_html__( 'Display Active', 'meathouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'login',
					'options'   => [
						'login'   => esc_html__( 'Login', 'meathouse' ),
						'signup'   => esc_html__( 'Sign Up', 'meathouse' ),
					],
		...
		$this->add_control(
            'show_login',
            [
                'label'         => esc_html__( 'Show Login', 'meathouse' ),
        ...
        $this->add_control(
            'show_register',
            [
                'label'         => esc_html__( 'Show Register', 'meathouse' ),
                'type'          => Controls_Manager::SWITCHER,
                'label_on'      => esc_html__( 'Yes', 'meathouse' ),
                'label_off'     => esc_html__( 'No', 'meathouse' ),
                'default'   => 'yes',
        ...
        $this->add_responsive_control(
				'form_width',
				[
					'label' 		=> esc_html__( 'Max. Width', 'meathouse' ),
        ...
        $this->add_control(
         ...
         $this->add_control(
					'form_color_remember',
					[
						'label' 	=> esc_html__( 'Form Remember Me Color', 'meathouse' ),
         ...
         $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Forget Password Color', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
         ...
         $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Forget Password Color Hover', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
         ...
         $this->add_control(
					'form_color_tab',
					[
						'label' 	=> esc_html__( 'Form Tab Color', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
          ...
          $this->add_control(
					'form_color_tab_link',
					[
						'label' 	=> esc_html__( 'Form Tab Link Color', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
          ...
          $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Tab Link Color Hover', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Color error', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					'form_color_login_ok',
					[
						'label' 	=> esc_html__( 'Form Color success', 'meathouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->start_controls_section(
			'heading-style',
			[
				'label' => esc_html__( 'Heading', 'meathouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
        ...
        $this->start_controls_section(
			'input-style',
			[
				'label' => esc_html__( 'Input', 'meathouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
        ...
        $this->add_group_control(
				...
				[
					'name' 		=> 'input_border',
					'label' 	=> esc_html__( 'Input Border', 'meathouse' ),
					'selector' 	=> '{{WRAPPER}} #jws-login-form .jws-animation form .input',
				]
		);
        $this->end_controls_section();
        $this->start_controls_section(
			'submit-style',
			[
				'label' => esc_html__( 'Submit Input', 'meathouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
