...
class Jws_Price_Table extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Price Table', 'meathouse' );
	}
	...
	protected function register_controls() {
		...
		$products_plan_array = array( esc_html__( '', 'meathouse' ) => 'Choose plan' );
		...
		$this->start_controls_section(
			'section_side',
			[
				'label' => esc_html__( 'Settings', 'meathouse' ),
			]
		);
        $this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Subscription Plan', 'meathouse' ),
			]
		);
        $this->add_control(
			'text-nav-on',
			[
				'label' => __( 'Nav', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'meathouse' ),
				'label_off' => __( 'No', 'meathouse' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
        $this->add_control(
			'text-nav-1', [
				'label' => __( 'Text nav 1', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Monthly' , 'meathouse' ),
				'label_block' => true,
                'condition' => [
						'text-nav-on' => [ 'yes' ],
				],
         ...
         $this->add_control(
			'text-nav-2', [
				'label' => __( 'Text nav 2', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Yearly' , 'meathouse' ),
				'label_block' => true,
                'condition' => [
						'text-nav-on' => [ 'yes' ],
				],
		...
		$this->start_controls_section(
			'section_pricing_1',
			[
				'label' => esc_html__( 'Pricing 1', 'meathouse' ),
			]
		);
        $this->add_control(
			'section_pricing_1_roles',
			[
				'label' => esc_html__( 'Roles', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'PERSONAL', 'meathouse' ),
			]
		);
        $this->add_control(
			'section_pricing_1_popular',
			[
				'label' => __( 'Popular', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'meathouse' ),
				'label_off' => __( 'No', 'meathouse' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Popular Text', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'POPULAR', 'meathouse' ),
                'condition' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Free', 'meathouse' ),
			]
		);
        $this->add_control(
			'section_pricing_1_price_mon',
			[
				'label' => esc_html__( 'Price Monthly', 'meathouse' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Price Year', 'meathouse' ),
				'type' => Controls_Manager::NUMBER,
			]
		);
		...
		$repeater->add_control(
			'section_pricing_1_fr_text', [
				'label' => __( 'Title', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'List Title' , 'meathouse' ),
				'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control(
			...
			[
				'label' => __( 'Chooose Type', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'text',
				'options' => [
					'text'  => __( 'Text', 'meathouse' ),
					'check' => __( 'Check', 'meathouse' ),
				],
			]
		);
        $repeater->add_control(
			'section_pricing_1_fr_name_mobile', [
				'label' => __( 'Title Mobile', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'List Title' , 'meathouse' ),
				'label_block' => true,
			]
		...
		$this->add_control(
			'list1',
			[
				'label' => __( 'Feature List Value', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'section_pricing_1_fr_text' => __( 'text #1', 'meathouse' ),
         ...
         $this->add_control(
			...
			[
				'label' => esc_html__( 'Button Buy Name', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Get started', 'meathouse' ),
			]
		);
        $this->add_control(
			'section_pricing_1_buy_free',
			[
				'label' => __( 'Plan Free', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'meathouse' ),
				'label_off' => __( 'No', 'meathouse' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Plan add to cart (Plan ID) for month', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Plan add to cart (Plan ID) for year', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' =>  $products_plan_array,
                'condition' => [
						'section_pricing_1_buy_free' => [ 'no' ],
		...
		$this->start_controls_section(
			'section_pricing_2',
			[
				'label' => esc_html__( 'Pricing 2', 'meathouse' ),
			]
		);
        $this->add_control(
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'meathouse' ),
				'type' => Controls_Manager::NUMBER,
				'default' => esc_html__( 'Business', 'meathouse' ),
			]
		);
        $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'section_pricing_2_fr_text' => __( 'text #1', 'meathouse' ),
         ...
         $this->add_control(
			...
			[
				'label' => esc_html__( 'Button Buy Name', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Get Business', 'meathouse' ),
			]
		);
        $this->add_control(
		...
		$this->start_controls_section(
			'section_pricing_3',
			[
				'label' => esc_html__( 'Pricing 3', 'meathouse' ),
			]
		);
        $this->add_control(
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Enterprise', 'meathouse' ),
			]
		);
        $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'section_pricing_3_fr_text' => __( 'text #1', 'meathouse' ),
         ...
         $this->add_control(
			...
			[
				'label' => esc_html__( 'Button Buy Name', 'meathouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Get Enterprise', 'meathouse' ),
			]
		);
        $this->add_control(
                                        ...
                                        <div class="plan-price">
                                            <?php 
                                                ...
                                                if($settings['section_pricing_'.$i.'_price_mon'] > 0 || !empty($settings['section_pricing_'.$i.'_price_mon'])) { ?>
                                                    <?php echo esc_html__('from ','meathouse'); ?>
                                                    <span class="mon price-select active" data-plan="month"><?php echo '<span>'.esc_html($currency_symbol.$settings['section_pricing_'.$i.'_price_mon']).'</span>'; echo esc_html__('/month ','meathouse'); ?></span>
                                                    <span class="year price-select" data-plan="year"><?php echo '<span>'.esc_html($currency_symbol.$settings['section_pricing_'.$i.'_price_year']).'</span>'; echo esc_html__('/month ','meathouse'); ?></span>      
                                                <?php }else{
                                                    echo '-';
                                                }
                                            ?>
