...
class Progress extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Progress', 'meathouse' );
    }
	/**
	...
	protected function register_controls() {
        ...
        $this->add_control(
				...
				[
					...
					'default'   => 'list',
					'options'   => [
						'list'   => esc_html__( 'List', 'meathouse' ),
						'tab'   => esc_html__( 'Tabs', 'meathouse' ),
                        'slider'   => esc_html__( 'Slider', 'meathouse' ),
                        'list_hover'   => esc_html__( 'List Hover', 'meathouse' ),
                        'grid_animation'   => esc_html__( 'Grid Animation', 'meathouse' ),
					],
				]
		);
        ...
        $repeater->add_control(
			'list_number', [
				...
				'default' => esc_html__( '1' , 'meathouse' ),
				'label_block' => true,
			]
		);
        $repeater->add_control(
		...
		$repeater->add_control(
			'list_title', [
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'List Title' , 'meathouse' ),
				'label_block' => true,
			]
		);
        $repeater->add_control(
