...
class Row_Sticky {
	...
	public function _addStickyEffect( $el ) {
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Sticky', 'meathouse'),
        ...
        $el->add_control(
            'enable_fixed_bottom',
            [
                'label' => __('Fixed to Bottom', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'meathouse' ),
                'label_off' => __( 'Hide', 'meathouse' ),
                'return_value' => 'menu',
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Desktop Sticky', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'meathouse'),
                'label_off' => __('No', 'meathouse'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Tablet Sticky', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'meathouse'),
                'label_off' => __('No', 'meathouse'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Mobile Sticky', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'meathouse'),
                'label_off' => __('No', 'meathouse'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Scroll Up Sticky', 'meathouse'),
                'description' => __('Header sticky only when scroll up', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'meathouse'),
                'label_off' => __('No', 'meathouse'),
                'default' => '',
        ...
        $el->add_responsive_control(
            ...
            [
                'label' => __('Sticky Offset Top', 'meathouse'),
        ...
        $el->add_responsive_control(
            'sticky_transparent',
            [
                'label' => __('Sticky Transparent', 'meathouse'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'meathouse'),
                'label_off' => __('No', 'meathouse'),
                'default' => '',
        ...
        $el->add_control(
            'sticky_effect_color',
            [
                'label' => __('Sticky Color', 'meathouse'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'description' => __('For Clever Header&#8217;s Widgets only.', 'meathouse'),
                'selectors' => [
        ...
        $el->add_control(
            ...
            [
                'label' => __('Sticky Color Hover', 'meathouse'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'description' => __('For Clever Header&#8217;s Widgets only.', 'meathouse'),
                'selectors' => [
        ...
        $el->add_control(
            ...
            [
                'label' => __('Sticky Background Color', 'meathouse'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}}.is-sticky , .mega-has-hover {{WRAPPER}}' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'enable_sticky_effect!' => ''
                ],
        ...
        $el->add_group_control(
            ...
            [
                'label' => esc_html__('Sticky Box Shadow', 'meathouse'),
        ...
        if ($el instanceof Widget_Base) {
            $el->add_control(
                ...
                [
                    'label' => __('Stay In Column', 'meathouse'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'enable_sticky_effect!' => '',
                    ],
