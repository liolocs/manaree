...
class Plugin {
    ...
    public function register_widgets() {
        ...
        require_once (JWS_ABS_PATH . '/inc/elementor_widget/widgets/meat_price_list/meat_price_list.php');
        require_once (JWS_ABS_PATH . '/inc/elementor_widget/widgets/image_carousel/image_carousel.php');
        require_once (JWS_ABS_PATH . '/inc/elementor_widget/widgets/meat_box/meat_box.php');
        require_once (JWS_ABS_PATH . '/inc/elementor_widget/widgets/split_slider/split_slider.php');
        ...
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Meat_price_list());
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Jws_Image_Carousel());
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Jws_Meat_Box());
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Jws_Split_Slider());
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Jws_Template());
        \Elementor\Plugin::instance()->widgets_manager->register(new Elementor\Timeline());
    ...
    public function register_categoris() {
        \Elementor\Plugin::$instance->elements_manager->add_category('jws-elements', ['title' => esc_html__('JWS Themes Widget', 'meathouse'), 'icon' => 'fa fa-plug', ], 1);
    }
    ...
    public function register_document_controls( $document ) { 
        ...
        $document->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Jws Custom CSS', 'meathouse' ),
    ...
    public function jws_add_icon_library( $icons ) {
			...
			$icons['jws-icons'] = array(
				'name'          => 'jws',
				'label'         => esc_html__( 'Jws Icons', 'meathouse' ),
				'prefix'        => 'jws-icon-',
				'displayPrefix' => ' ',
				'labelIcon'     => 'jws-icon',
...
add_action( 'elementor/element/icon-box/section_icon/before_section_end', function( $element, $args ) {
     ...
     $element->add_control(
			'hover_select',
			[
				'label' =>  esc_html__( 'Hover Change All Content', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'none' =>  esc_html__( 'none', 'meathouse' ),
                    'all' =>  esc_html__( 'All Content', 'meathouse' ),
				],
				'default' => 'none',
...
add_action( 'elementor/element/counter/section_number/before_section_end', function( $element, $args ) {
       ...
       $element->add_control(
			'jws_suffix',
			[
				'label' =>  esc_html__( 'Suffix Color', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
...
add_action( 'elementor/element/accordion/section_toggle_style_icon/before_section_end', function( $element, $args ) {
        ...
        $element->add_control(
			'icon_width_height',
			[
				'label' 		=> esc_html__( 'Icon Width Height', 'meathouse' ),
     ...
     $element->add_group_control(
       ...
       $element->add_control(
			'icon_bg_active',
			[
				'label' =>  esc_html__( 'Background Active', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
...
add_action( 'elementor/element/accordion/section_toggle_style_title/before_section_end', function( $element, $args ) {
         ...
         $element->add_control(
			'toggle_radius',
			[
				'label' =>  esc_html__( 'Boder Radius', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
       ...
       $element->add_group_control(
        ...
        $element->add_group_control(
			...
			[
				...
				'label' =>  esc_html__( 'Box Shadow Active', 'meathouse' ),
...
add_action( 'elementor/element/button/section_style/before_section_end', function( $element, $args ) {
        ...
        $element->add_control(
         ...
         $element->add_control(
			'icon_btn_margin',
			[
				'label' =>  esc_html__( 'Icon Margin', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
...
add_action( 'elementor/element/tabs/section_tabs_style/before_section_end', function( $element, $args ) {
        $element->add_responsive_control(
			'tabnav_padding',
			[
				'label' =>  esc_html__( 'Navigation Padding', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $element->add_responsive_control(
			'tab_padding',
			[
				'label' =>  esc_html__( 'Title Padding', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
         ...
         $element->add_responsive_control(
			'tab_margin',
			[
				'label' =>  esc_html__( 'Title Margin', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
...
add_action( 'elementor/element/progress/section_progress_style/before_section_end', function( $element, $args ) {
       $element->add_group_control(
         ...
         $element->add_control(
			...
			[
				'label' =>  esc_html__( 'Border Radius Inner', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
...
add_action( 'elementor/element/tabs/section_tabs_style/before_section_end', function( $element, $args ) {
        $element->add_responsive_control(
			'icon_size',
			[
				'label' =>  esc_html__( 'Content Width', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%'],
				'range' => [
					'%' => [
...
add_action( 'elementor/element/animated-headline/section_style_text/before_section_end', function( $element, $args ) {
       ...
       $element->add_control(
			...
			[
				'label' =>  esc_html__( 'Animated Clip After Color', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
...
add_action( 'elementor/element/post-info/section_text_style/before_section_end', function( $element, $args ) {
       ...
       $element->add_control(
        ...
        $element->add_control(
			...
			[
				'label' =>  esc_html__( 'Before Color', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
...
add_action( 'elementor/element/column/section_style/before_section_end', function( $element, $args ) {
        $element->add_control(
			'enable_bg_before',
			[
				'label' => esc_html__( 'Enable Before Background', 'meathouse' ),
       ...
       $element->add_control(
			'bg_align',
			[
				'label' => esc_html__( 'Before Background Align', 'meathouse' ),
...
add_action( 'elementor/element/image/section_style_image/before_section_end', function( $element, $args ) {
        ...
        $element->add_control(
			...
			[
				'label' => esc_html__( 'Enable 360 Anomation', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
