...
class Jws_Section extends Elementor\Element_Section {
	...
	protected static function get_default_edit_tools() {
		$section_label = __( 'Section', 'meathouse' );

		return [
			'duplicate' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Duplicate %s', 'meathouse' ), $section_label ),
				'icon' => 'clone',
			],
			'add' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Add %s', 'meathouse' ), $section_label ),
				'icon' => 'plus',
			],
			'save' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Save %s', 'meathouse' ), $section_label ),
				'icon' => 'save',
			],
			'remove' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Remove %s', 'meathouse' ), $section_label ),
				'icon' => 'close',
			],
		];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_additional',
			array(
				'label' => esc_html__( 'Jws Settings', 'meathouse' ),
	   ...
	   $this->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Use Section For', 'meathouse' ),
					'default' => '',
					'options' => array(
						''          => esc_html__( 'Default', 'meathouse' ),
       ...
       $this->start_controls_section(
        ...
        $this->add_control(
				'nav_icon',
				[
					'label' => esc_html__( 'Nav Icon', 'meathouse' ),
        ...
        $this->add_responsive_control(
			'nav_width_height',
			[
				'label' => esc_html__( 'Nav Width Height', 'meathouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_responsive_control(
			'nav_prev_space',
			[
				'label' => esc_html__( 'Nav Prev Space', 'meathouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_responsive_control(
			'nav_next_space',
			[
				'label' => esc_html__( 'Nav Next Space', 'meathouse' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_control(
				'dots_align',
				[
					'label' 		=> esc_html__( 'Dots Align', 'meathouse' ),
        ...
        $this->add_control(
			'dots_color',
			[
				'label' => esc_html__( 'Dots Color', 'meathouse' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .slider-dots-box .slider-dots button:after' => 'border-color: {{VALUE}}',
                    '{{WRAPPER}} .slider-dots-box .slider-dots .slick-active button:after' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .slider-dots-box .slider-dots button:after' => 'border-color: {{VALUE}}',
                    '{{WRAPPER}} .slider-dots-box .slider-dots button .circle-go' => 'stroke: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			'dots_padding',
			[
				'label' => esc_html__( 'Dots Margin', 'meathouse' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
       ...
       $this->start_controls_section(
        ...
        $this->add_control(
			'vertical',
			[
				'label'        => esc_html__( 'Vertical', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
        ...
        $this->add_control(
			'wheel',
			[
				'label'        => esc_html__( 'Wheel', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
        ...
        $this->add_control(
			'fade',
			[
				'label'        => esc_html__( 'Fade', 'meathouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
			]
	...
	public function before_render() {
		...
		<<?php echo esc_html( $this->get_html_tag() ); ?> <?php $this->print_render_attribute_string( '_wrapper' ); ?>>
			...
			$has_background_overlay =  (isset($settings['background_overlay_background']) && in_array( $settings['background_overlay_background'], [ 'classic', 'gradient' ], true )) ||
									 (isset($settings['background_overlay_hover_background']) && in_array( $settings['background_overlay_hover_background'], [ 'classic', 'gradient' ], true ));
