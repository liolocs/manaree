...
if ( ! class_exists( 'Jws_Walker_Page' ) ) {
	/**
	 * CUSTOM PAGE WALKER
	 * A custom walker for pages.
	 */
	class Jws_Walker_Page extends Walker_Page {
		...
		public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
			...
			if ( isset( $args['pages_with_children'][ $page->ID ] ) ) {
				$css_class[] = 'page_item_has_children menu-item-has-children menu-item-design-standard';
			}
			...
			if ( '' === $page->post_title ) {
				...
				$page->post_title = sprintf( esc_html__( '#%d (no title)', 'meathouse' ), $page->ID );
			}
