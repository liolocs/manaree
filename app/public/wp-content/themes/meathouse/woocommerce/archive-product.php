...
<div class="<?php echo esc_attr($shop['class_wap']); ?>">
    <div class="row">
         <?php if($shop['position'] == 'left' || $shop['filter_layout'] == 'sideout') { ?>
            <div class="<?php echo esc_attr($shop['sidebar_col']); ?>">
                ...
                <div class="jws-filter-modal">
                    ...
                    <div class="modal-top">
                        <span class="modal-title"><?php echo esc_html__('FILTER BY:','meathouse'); ?></span>
                        <span class="modal-close"><?php echo esc_html__('Close','meathouse'); ?></span>
                    </div>
                        <?php
        ...
        if($shop['filter_layout'] == 'bottom' || $shop['filter_layout'] == 'top') { 
          shop_filter_content();   
        }
        ...
        <?php if($shop['position'] == 'right') { ?>
              ...
              <div class="jws_sticky_move">
                <div class="jws-filter-modal">
                    ...
                    <div class="modal-top">
                        <span class="modal-title"><?php echo esc_html__('FILTERS','meathouse'); ?></span>
                        <span class="modal-close"><?php echo esc_html__('Close','meathouse'); ?></span>
                    </div>
                        <?php
                            if ( is_active_sidebar( 'sidebar-shop' ) ) {
