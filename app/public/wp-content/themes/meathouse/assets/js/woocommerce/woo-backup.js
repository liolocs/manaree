   ...
   single_product_js() {
         $('body.single-product').on('adding_to_cart', function() {
           ...
           if ($('body > .woocommerce-error').length) {
              ...
              var loc = $('body > .woocommerce-error').appendTo('.jws-notices').append('<span class="note-close jws-icon-cross"></span>').wrap('<div class="note-item"></div>');
    ...
    if ($('.woocommerce-error li').length) {
        ...
        if (_billing) {
            ...
            addToCartAllTypes: function() {
                ...
                $('body').on('submit', '.main-product form.cart', function(e) {
                    e.preventDefault();
                    var $form = $(this),
            ...
            swatchesVariations: function() {
                ...
                var scrollToTop = function() {
                    if (!$('body').hasClass('meathouseduct-design-sticky') || !$('.entry-summary').hasClass('block-sticked') || $(window).width() <= 1024) return;
                    $('html, body').animate({
            ...
            filterAjax: function() {
                ...
                $(document.body).on('change', '#pgs_product_pp , .orderby', function(e) {
                    ...
                    $(document.body).trigger('meathouse_catelog_filter_ajax', [url, $(this)]);
                ...
                $(document.body).on('meathouse_catelog_filter_ajax', function(e, url, element) {
                    ...
                    $(document.body).trigger('meathouse_ajax_filter_before_send_request');
                    clearInterval(intervalID);
                    $.get(url, function(res) {
                        $('html,body').animate({
                        ...
                        $(document.body).trigger('meathouse_ajax_filter_request_success', [res, url]);
                ...
                $(document.body).on('meathouse_ajax_filter_before_send_request', function() {
