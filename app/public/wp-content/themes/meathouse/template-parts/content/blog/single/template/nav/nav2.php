                        ...
                        if(!empty($prev_post)){    
                            ...
                            echo '<div class="left">
                                   <div class="content_nav">
                                        <span><i class="jws-icon-glyph"></i>'.esc_html__('Previous Post','meathouse').'</span>
                                        <h6 class="title">
                                ...
                                echo '<div class="left">
                                   <div class="content_nav">
                                        <span>'.esc_html__('Previous Post','meathouse').'<i class="jws-icon-glyph"></i></span>
                                        <h6 class="title">
                            ...
                            if(!empty($next_post)){
                                   ...
                                   echo '<div class="right">
                                            ...
                                            <div class="content_nav">
                                               <span>'.esc_html__('Next Post','meathouse').'<i class="jws-icon-glyph-1"></i></span> 
                                               <h6 class="title">
